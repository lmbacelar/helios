Feature: IEC 60751 Measurement Management
  ...
  Scenario: List all measurements when there are no measurements
    Given I have no "IEC 60751 Measurements" for "IEC 60751 PRT" with name "PRT1"
  ...
  Scenario: Access the new measurement form
    ...
    Then  I should be on the new "IEC 60751 Measurement" page for "IEC 60751 PRT" with name "PRT1"
 ...
 Scenario: Delete measurement
    ...
    Then  I should be on the "IEC 60751 Measurements" page for "IEC 60751 PRT" with name "PRT1"
